...
<ul style="text-indent:50px; text-align:justify;list-style-position: inside">
<li>In underground mining, construction involves the creation of galleries, drifts and panels. Numerous instances, certain parts of the mining areas can be sealed. Both of these considerations must be taken into account during the preparation of the mine. At this stage, we need to make an approximation of the resistance that would be encountered and then the subsequent cost of ventilation, the power of the fans to set up, etc. </li>
<li>To calculate the resistance as well as the cost of ventilating mine galleries or airways even though work has not begun. </li>
<li>In order to design the shortest possible mine airway network with the highest efficiency, it is important to calculate the coefficient of friction.</li>
</ul>
